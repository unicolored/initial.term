...
/**
   ...
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */,lt={attribute:!0,type:String,converter:w,reflect:!1,hasChanged:m},at=(t=lt,i,s)=>{const{kind:e,metadata:o}=s;let n=globalThis.litPropertyMetadata.get(o);if(void 0===n&&globalThis.litPropertyMetadata.set(o,n=new Map),n.set(s.name,t),"accessor"===e){const{name:e}=s;return{set(s){const o=i.get.call(this);i.set.call(this,s),this.requestUpdate(e,o,t)},init(i){return void 0!==i&&this.P(e,void 0,t),i}}}if("setter"===e){const{name:e}=s;return function(s){const o=this[e];i.call(this,s),this.requestUpdate(e,o,t)}}throw Error("Unsupported decorator location: "+e)};function ct(t){return(i,s)=>"object"==typeof s?at(t,i,s):((t,i,s)=>{const e=i.hasOwnProperty(s);return i.constructor.createProperty(s,e?{...t,wrapped:!0}:t),e?Object.getOwnPropertyDescriptor(i,s):void 0})(t,i,s)}const dt=r`
  :host {
...
/**
   ...
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */class Tt extends vt{constructor(t){if(super(t),this.it=J,t.type!==ft)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===J||null==t)return this._t=void 0,this.it=t;if(t===D)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const i=[t];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}}Tt.directiveName="unsafeHTML",Tt.resultType=1;const Ut=pt(Tt);var Mt=function(t,i,s,e){for(var o,n=arguments.length,r=n<3?i:null===e?e=Object.getOwnPropertyDescriptor(i,s):e,h=t.length-1;h>=0;h--)(o=t[h])&&(r=(n<3?o(r):n>3?o(i,s,r):o(i,s))||r);return n>3&&r&&Object.defineProperty(i,s,r),r};let Ot=class extends nt{constructor(){super(),this.banner='initial.sh - Type "info"',this.sounds=!0,this.theInput=new St,this.audio=null,this.site=window.location.hostname||"unknown site",this.browser=function(){const t=navigator.userAgent.toLowerCase();return t.includes("firefox")?"Firefox":t.includes("chrome")?"Chrome":t.includes("safari")?"Safari":t.includes("edge")?"Edge":t.includes("opera")||t.includes("opr")?"Opera":"Unknown Browser"}(),this.pluginCommands={},this.history=[],this.messages=[],this.typedMessages=[],this.typingSpeed=100,this.shell=new _t({banner:this.banner}),this.sounds&&(this.audio=new ut),this.promptSign=Et`${[this.site,["blue","bold"]]}@${[this.browser,["green","bold"]]} >> `,this.shell.init()}firstUpdated(){const t=this.shadowRoot?.querySelectorAll("p.typed");t&&t.forEach((t=>{}))}disconnectedCallback(){this.shell.clear(),super.disconnectedCallback()}render(){return this.history=[...this.shell.history],this.messages=[...this.shell.messages],W`
      <div class="console" @click=${this.handleClick}>
        <div class="terminal">
          <div class="shell">
            ...
            ${this.messages.map((t=>W`<p class="typed">${Ut(t)}</p>`))}
          </div>
          <div class="input-line">
            <span class="prompt">
              ${W`${Ut(this.promptSign)}`}
            </span>
            <input
              ${Ct(this.theInput)}
